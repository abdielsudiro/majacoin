...
Note
---------------------
Always use absolute paths to configure and compile.Majacoin and the dependencies,
...
This will build.Majacoin-Qt as well if the dependencies are met.
...
memory available when compiling.Majacoin Core. With 512MB of memory or less
...
If you want to build.Majacoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a.Majacoin-Qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip.Majacoind" to strip the debug
...
Security
--------
To help make your.Majacoin installation more secure by making certain attacks impossible to
