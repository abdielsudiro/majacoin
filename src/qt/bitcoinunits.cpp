...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MJC");
    case mBTC: return QString("mMJC");
    case uBTC: return QString::fromUtf8("μMJC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MJCs");
    case mBTC: return QString("Milli-MJCs (1 / 1,000)");
    case uBTC: return QString("Micro-MJCs (1 / 1,000,000)");
    default: return QString("???");
    }
}
