...
// Copyright (c) 2017 Empinel / The MJC Developers
// Copyright (c) 2017 Empinel / The.Majacoin Developers
...
//
// Bootup the masternode, look for a 50000 MJC input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in .Majacoin.conf */
